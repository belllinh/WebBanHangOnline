namespace WebBanHangOnline.Migrations
{
    ...
    public partial class CreateDaatabase : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.tb_Category", t => t.Categoryes_Id)
                .Index(t => t.Categoryes_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.tb_Posts", "Categoryes_Id", "dbo.tb_Category");
            DropForeignKey("dbo.tb_News", "Categoryes_Id", "dbo.tb_Category");
            ...
            DropIndex("dbo.tb_Posts", new[] { "Categoryes_Id" });
            DropIndex("dbo.tb_News", new[] { "Categoryes_Id" });
